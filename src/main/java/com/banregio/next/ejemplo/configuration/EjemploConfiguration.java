package com.banregio.next.ejemplo.configuration;
    ...
    public ExcludeSecurityServices excludeSecurityServices(NextProperties props) {
		return new ExcludeSecurityServices() {
            ...
            public void addServices(ServiciosContainer services) {
            	...
            	services.serviciosSinTokenAccesoExterno("/remoto-categoria/**"); //Esta configuración permite consumir los servicios de ejemplo sin seguridad
            	services.serviciosSinTokenAccesoExterno("/remoto-producto/**");
            }
